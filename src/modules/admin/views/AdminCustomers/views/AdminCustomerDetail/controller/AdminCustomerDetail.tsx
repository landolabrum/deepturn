...
import ProductRequest from '../views/AdminCustomerProductRequest';

const AdminCustomerDetails: React.FC<any> = ({ customerId }: any) => {
    ...
    return (
      <>
        ...
        <div className='admin-customer'>
          {productRequest && <ProductRequest productRequest={productRequest} />}
...
//       <style jsx>{styles}</style>
//       <div className='admin-customer'>
//         {productRequest && <ProductRequest productRequest={productRequest} />} {/* Render ProductRequest */}
