...
import styles from './OnboardingForm.scss';
...
const OnboardingForm = ({  closeModal }: JoinRegisterProps) => {
  ...
  const handleSubmit = async (incoming_fields:any) => {


    const [firstName = '', lastName = ''] = (incoming_fields.name || '').split(' ');
  ...
  }), [fields, handleSubmit, user,sessionData!== undefined]);
    ...
    <>
      ...
      <div className="onboard">
        <div className="onboard__content">
          <div className="onboard__content--body">
            {fields?.length && (
              <UiViewLayout
                currentView="join"
                views={views}
